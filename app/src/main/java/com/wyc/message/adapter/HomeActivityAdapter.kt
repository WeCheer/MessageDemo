 ...
 *作者： wyc
 * <p>
 * 创建时间： 2019/11/20 19:31
 * <p>
 * 文件名字： com.wyc.vivodemo
 * <p>
 * 类的介绍：
 */
class HomeActivityAdapter(private var mContext: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun setOnHomeActivityItemClickListener(listener: (view: View, position: Int) -> Unit) {
